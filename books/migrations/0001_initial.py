# Generated by Django 3.2.4 on 2021-07-15 13:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plot', models.TextField(blank=True, max_length=255)),
                ('category', models.CharField(choices=[('hardcover', 'Hardcover'), ('paperback', 'Paperback'), ('digital copy', 'Digital Copy')], default='hardcover', max_length=20)),
                ...
                ('thumbnails', models.ImageField(default='/default/no-img.jpg', upload_to='books')),
